...
%% Global Variables
% define global variables to share with function file oscil_eqn.m
...
% gamma. SI units assumed for graph labels. Third gamma chosen as point at
% which chaotic motion about to begin ~ 1.32 to 2d.p
OMEGA = 2;
%GAMMA = 0.5;
%GAMMA = 1.5;
GAMMA = 1.32;
...
% probably floating point error. elems is vector of indices of all elements between 20T & 60T
% inclusive. Very slow, especially for big ranges
start_find = 20*T;
end_find = 60*T;
...
% for chaotic behaviour at GAMMA=1.5 the oscillator ends up in a
